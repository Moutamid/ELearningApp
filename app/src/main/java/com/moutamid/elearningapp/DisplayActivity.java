...
import com.moutamid.elearningapp.adapters.DisplayAdapter;
...
public class DisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DisplayAdapter adapter = new DisplayAdapter(getSupportFragmentManager(), this, tabLayout.getTabCount());
